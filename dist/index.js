...
var require_zod_is_type = __commonJS((exports) => {
  var isZodType = function(schema, typeName) {
    var _a;
    return ((_a = schema === null || schema === undefined ? undefined : schema._def) === null || _a === undefined ? undefined : _a.typeName) === typeName;
  };
  var isAnyZodType = function(schema) {
    return "_def" in schema;
  };
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.isAnyZodType = exports.isZodType = undefined;
...
var require_zod_extensions = __commonJS((exports) => {
  var preserveMetadataFromModifier = function(zod, modifier) {
  ...
  var extendZodWithOpenApi = function(zod) {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.extendZodWithOpenApi = undefined;
...
var require_object_set = __commonJS((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.ObjectSet = exports.isEqual = undefined;
...
var require_lodash = __commonJS((exports) => {
  ...
  var omitBy = function(object, predicate) {
    const result = {};
    Object.entries(object).forEach(([key, value]) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.uniq = exports.objectEquals = exports.compact = exports.omitBy = exports.omit = exports.mapValues = exports.isNil = exports.isUndefined = undefined;
...
var require_openapi_metadata = __commonJS((exports) => {
  var getOpenApiMetadata = function(zodSchema) {
    var _a, _b;
    return (0, lodash_1.omitBy)((_b = (_a = zodSchema._def.openapi) === null || _a === undefined ? undefined : _a.metadata) !== null && _b !== undefined ? _b : {}, lodash_1.isNil);
  };
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.getOpenApiMetadata = undefined;
  var lodash_1 = require_lodash();
  exports.getOpenApiMetadata = getOpenApiMetadata;
});

// node_modules/@asteasolutions/zod-to-openapi/dist/openapi-registry.js
var require_openapi_registry = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.OpenAPIRegistry = undefined;
...
var require_identity = __commonJS((exports) => {
  var isCollection = function(node4) {
    if (node4 && typeof node4 === "object")
      switch (node4[NODE_TYPE]) {
        case MAP:
        case SEQ:
          return true;
      }
  ...
  var isAlias = (node4) => !!node4 && typeof node4 === "object" && node4[NODE_TYPE] === ALIAS;
  var isDocument = (node4) => !!node4 && typeof node4 === "object" && node4[NODE_TYPE] === DOC;
  var isMap = (node4) => !!node4 && typeof node4 === "object" && node4[NODE_TYPE] === MAP;
  var isPair = (node4) => !!node4 && typeof node4 === "object" && node4[NODE_TYPE] === PAIR;
  var isScalar = (node4) => !!node4 && typeof node4 === "object" && node4[NODE_TYPE] === SCALAR;
  var isSeq = (node4) => !!node4 && typeof node4 === "object" && node4[NODE_TYPE] === SEQ;
  var hasAnchor = (node4) => (isScalar(node4) || isCollection(node4)) && !!node4.anchor;
  exports.ALIAS = ALIAS;
  exports.DOC = DOC;
  exports.MAP = MAP;
...
var require_visit = __commonJS((exports) => {
  var visit = function(node4, visitor) {
    const visitor_ = initVisitor(visitor);
    if (identity.isDocument(node4)) {
      const cd = visit_(null, node4.contents, visitor_, Object.freeze([node4]));
      if (cd === REMOVE)
        node4.contents = null;
    } else
      visit_(null, node4, visitor_, Object.freeze([]));
  };
  var visit_ = function(key, node4, visitor, path) {
    const ctrl = callVisitor(key, node4, visitor, path);
    if (identity.isNode(ctrl) || identity.isPair(ctrl)) {
      replaceNode(key, path, ctrl);
      return visit_(key, ctrl, visitor, path);
    }
    if (typeof ctrl !== "symbol") {
      if (identity.isCollection(node4)) {
        path = Object.freeze(path.concat(node4));
        for (let i = 0;i < node4.items.length; ++i) {
          const ci = visit_(i, node4.items[i], visitor, path);
          if (typeof ci === "number")
            i = ci - 1;
          else if (ci === BREAK)
            return BREAK;
          else if (ci === REMOVE) {
            node4.items.splice(i, 1);
            i -= 1;
          }
        }
      } else if (identity.isPair(node4)) {
        path = Object.freeze(path.concat(node4));
        const ck = visit_("key", node4.key, visitor, path);
        if (ck === BREAK)
          return BREAK;
        else if (ck === REMOVE)
          node4.key = null;
        const cv = visit_("value", node4.value, visitor, path);
        if (cv === BREAK)
          return BREAK;
        else if (cv === REMOVE)
          node4.value = null;
  ...
  async function visitAsync(node4, visitor) {
    const visitor_ = initVisitor(visitor);
    if (identity.isDocument(node4)) {
      const cd = await visitAsync_(null, node4.contents, visitor_, Object.freeze([node4]));
      if (cd === REMOVE)
        node4.contents = null;
    } else
      await visitAsync_(null, node4, visitor_, Object.freeze([]));
  }
  async function visitAsync_(key, node4, visitor, path) {
    const ctrl = await callVisitor(key, node4, visitor, path);
    if (identity.isNode(ctrl) || identity.isPair(ctrl)) {
      replaceNode(key, path, ctrl);
    ...
    if (typeof ctrl !== "symbol") {
      if (identity.isCollection(node4)) {
        path = Object.freeze(path.concat(node4));
        for (let i = 0;i < node4.items.length; ++i) {
          const ci = await visitAsync_(i, node4.items[i], visitor, path);
          if (typeof ci === "number")
            i = ci - 1;
          else if (ci === BREAK)
            return BREAK;
        ...
        path = Object.freeze(path.concat(node4));
        const ck = await visitAsync_("key", node4.key, visitor, path);
        if (ck === BREAK)
          return BREAK;
        else if (ck === REMOVE)
          node4.key = null;
        const cv = await visitAsync_("value", node4.value, visitor, path);
        if (cv === BREAK)
          return BREAK;
        else if (cv === REMOVE)
          node4.value = null;
  ...
  var callVisitor = function(key, node4, visitor, path) {
    if (typeof visitor === "function")
      return visitor(key, node4, path);
    if (identity.isMap(node4))
      return visitor.Map?.(key, node4, path);
    if (identity.isSeq(node4))
      return visitor.Seq?.(key, node4, path);
    if (identity.isPair(node4))
      return visitor.Pair?.(key, node4, path);
    if (identity.isScalar(node4))
      return visitor.Scalar?.(key, node4, path);
    if (identity.isAlias(node4))
      return visitor.Alias?.(key, node4, path);
    return;
  };
  var replaceNode = function(key, path, node4) {
    const parent = path[path.length - 1];
    if (identity.isCollection(parent)) {
      parent.items[key] = node4;
  ...
  class Directives {
    ...
    toString(doc) {
      ...
      if (doc && tagEntries.length > 0 && identity.isNode(doc.contents)) {
        const tags = {};
        visit.visit(doc.contents, (_key, node4) => {
          if (identity.isNode(node4) && node4.tag)
            tags[node4.tag] = true;
        });
...
var require_Alias = __commonJS((exports) => {
  var getAliasCount = function(doc, node4, anchors2) {
    if (identity.isAlias(node4)) {
      const source = node4.resolve(doc);
      const anchor = anchors2 && source && anchors2.get(source);
      return anchor ? anchor.count * anchor.aliasCount : 0;
    } else if (identity.isCollection(node4)) {
      let count = 0;
      for (const item of node4.items) {
      ...
      const kc = getAliasCount(doc, node4.key, anchors2);
      const vc = getAliasCount(doc, node4.value, anchors2);
  ...
  class Alias extends Node3.NodeBase {
    constructor(source) {
...
var require_Scalar = __commonJS((exports) => {
  ...
  class Scalar extends Node3.NodeBase {
    constructor(value) {
  ...
  var createNode = function(value, tagName, ctx) {
    ...
    if (!tagObj) {
      ...
      if (!value || typeof value !== "object") {
        const node5 = new Scalar.Scalar(value);
        if (ref)
          ref.node = node5;
        return node5;
      }
    ...
    const node4 = tagObj?.createNode ? tagObj.createNode(ctx.schema, value, ctx) : typeof tagObj?.nodeClass?.from === "function" ? tagObj.nodeClass.from(ctx.schema, value, ctx) : new Scalar.Scalar(value);
    if (tagName)
      node4.tag = tagName;
    else if (!tagObj.default)
      node4.tag = tagObj.tag;
    if (ref)
      ref.node = node4;
    return node4;
  };
...
var require_Collection = __commonJS((exports) => {
  ...
  class Collection extends Node3.NodeBase {
    ...
    addIn(path, value) {
      if (isEmptyPath(path))
        ...
        const [key, ...rest] = path;
        const node4 = this.get(key, true);
        if (identity.isCollection(node4))
          node4.addIn(rest, value);
        else if (node4 === undefined && this.schema)
    ...
    getIn(path, keepScalar) {
      ...
      const node4 = this.get(key, true);
      if (rest.length === 0)
        return !keepScalar && identity.isScalar(node4) ? node4.value : node4;
      else
        return identity.isCollection(node4) ? node4.getIn(rest, keepScalar) : undefined;
    }
    hasAllNullValues(allowScalar) {
      return this.items.every((node4) => {
        if (!identity.isPair(node4))
          return false;
        const n = node4.value;
    ...
    hasIn(path) {
      ...
      if (rest.length === 0)
        return this.has(key);
      const node4 = this.get(key, true);
      return identity.isCollection(node4) ? node4.hasIn(rest) : false;
    }
    setIn(path, value) {
      const [key, ...rest] = path;
      if (rest.length === 0) {
...
var require_foldFlowLines = __commonJS((exports) => {
  ...
  var consumeMoreIndentedLines = function(text, i, indent) {
    let end = i;
    let start = i + 1;
    let ch = text[start];
    while (ch === " " || ch === "\t") {
...
var require_stringifyString = __commonJS((exports) => {
  ...
  var blockString = function({ comment, type, value }, ctx, onComment, onChompKeep) {
    ...
    value = value.replace(/\n+/g, "\n$&").replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g, "$1$2").replace(/\n+/g, `\$&${indent}`);
    const body2 = foldFlowLines.foldFlowLines(`${start}${value}${end}`, indent, foldFlowLines.FOLD_BLOCK, getFoldOptions(ctx, true));
    return `${header}\n${indent}${body2}`;
  };
...
var require_stringify = __commonJS((exports) => {
  ...
  var stringifyProps = function(node4, tagObj, { anchors: anchors$1, doc }) {
    if (!doc.directives)
      return "";
    const props = [];
    const anchor = (identity.isScalar(node4) || identity.isCollection(node4)) && node4.anchor;
    if (anchor && anchors.anchorIsValid(anchor)) {
      anchors$1.add(anchor);
      props.push(`&${anchor}`);
    }
    const tag = node4.tag ? node4.tag : tagObj.default ? null : tagObj.tag;
    if (tag)
  ...
  var stringify = function(item, ctx, onComment, onChompKeep) {
    ...
    let tagObj = undefined;
    const node4 = identity.isNode(item) ? item : ctx.doc.createNode(item, { onTagObj: (o) => tagObj = o });
    if (!tagObj)
      tagObj = getTagObject(ctx.doc.schema.tags, node4);
    const props = stringifyProps(node4, tagObj, ctx);
    if (props.length > 0)
      ctx.indentAtStart = (ctx.indentAtStart ?? 0) + props.length + 1;
    const str = typeof tagObj.stringify === "function" ? tagObj.stringify(node4, ctx, onComment, onChompKeep) : identity.isScalar(node4) ? stringifyString.stringifyString(node4, ctx, onComment, onChompKeep) : node4.toString(ctx, onComment, onChompKeep);
    if (!props)
      return str;
    return identity.isScalar(node4) || str[0] === "{" || str[0] === "[" ? `${props} ${str}` : `${props}\n${ctx.indent}${str}`;
  };
  var anchors = require_anchors();
  var identity = require_identity();
...
var require_addPairToJSMap = __commonJS((exports) => {
  ...
  var stringifyKey = function(key, jsKey, ctx) {
    ...
    if (identity.isNode(key) && ctx?.doc) {
      ...
      for (const node4 of ctx.anchors.keys())
        strCtx.anchors.add(node4.anchor);
      strCtx.inFlow = true;
...
var require_stringifyCollection = __commonJS((exports) => {
  ...
  var stringifyFlowCollection = function({ items }, ctx, { flowChars, itemIndent }) {
...
var require_YAMLMap = __commonJS((exports) => {
  ...
  class YAMLMap extends Collection.Collection {
    ...
    get(key, keepScalar) {
      const it = findPair(this.items, key);
      const node4 = it?.value;
      return (!keepScalar && identity.isScalar(node4) ? node4.value : node4) ?? undefined;
    }
    has(key) {
...
var require_float = __commonJS((exports) => {
  ...
  var floatExp = {
    ...
    stringify(node4) {
      const num = Number(node4.value);
      return isFinite(num) ? num.toExponential() : stringifyNumber.stringifyNumber(node4);
    }
  };
  var float = {
    identify: (value) => typeof value === "number",
    ...
    test: /^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,
    resolve(str) {
      const node4 = new Scalar.Scalar(parseFloat(str));
      const dot = str.indexOf(".");
      if (dot !== -1 && str[str.length - 1] === "0")
        node4.minFractionDigits = str.length - dot - 1;
      return node4;
    },
    stringify: stringifyNumber.stringifyNumber
  };
...
var require_int = __commonJS((exports) => {
  var intStringify = function(node4, radix, prefix) {
    const { value } = node4;
    if (intIdentify(value) && value >= 0)
      return prefix + value.toString(radix);
    return stringifyNumber.stringifyNumber(node4);
  };
  var stringifyNumber = require_stringifyNumber();
  ...
  var intOct = {
    ...
    stringify: (node4) => intStringify(node4, 8, "0o")
  };
  var int = {
  ...
  var intHex = {
    ...
    stringify: (node4) => intStringify(node4, 16, "0x")
  };
  exports.int = int;
...
var require_float2 = __commonJS((exports) => {
  ...
  var float = {
    ...
    test: /^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,
    resolve(str) {
      const node4 = new Scalar.Scalar(parseFloat(str.replace(/_/g, "")));
      const dot = str.indexOf(".");
      if (dot !== -1) {
        const f = str.substring(dot + 1).replace(/_/g, "");
        if (f[f.length - 1] === "0")
          node4.minFractionDigits = f.length;
      }
      return node4;
    },
    stringify: stringifyNumber.stringifyNumber
...
var require_int2 = __commonJS((exports) => {
  ...
  var intBin = {
    ...
    stringify: (node4) => intStringify(node4, 2, "0b")
  };
  var intOct = {
    identify: intIdentify,
    default: true,
    ...
    stringify: (node4) => intStringify(node4, 8, "0")
  };
  var int = {
    identify: intIdentify,
    default: true,
...
var require_timestamp = __commonJS((exports) => {
  ...
  var stringifySexagesimal = function(node4) {
    let { value } = node4;
    let num = (n) => n;
    if (typeof value === "bigint")
      num = (n) => BigInt(n);
...
var require_Document = __commonJS((exports) => {
  ...
  class Document {
    ...
    createAlias(node4, name) {
      if (!node4.anchor) {
        const prev = anchors.anchorNames(this);
        node4.anchor = !name || prev.has(name) ? anchors.findNewAnchor(name || "a", prev) : name;
      }
      return new Alias.Alias(node4.anchor);
    }
    createNode(value, replacer, options) {
      ...
      const node4 = createNode.createNode(value, tag, ctx);
      if (flow && identity.isCollection(node4))
        node4.flow = true;
      setAnchors();
      return node4;
    }
...
var require_resolve_block_seq = __commonJS((exports) => {
  var resolveBlockSeq = function({ composeNode, composeEmptyNode }, ctx, bs, onError, tag) {
    ...
    for (const { start, value } of bs.items) {
      ...
      const node4 = value ? composeNode(ctx, value, props, onError) : composeEmptyNode(ctx, props.end, start, null, props, onError);
      if (ctx.schema.compat)
        utilFlowIndentCheck.flowIndentCheck(bs.indent, value, onError);
      offset = node4.range[2];
      seq.items.push(node4);
    }
...
var require_compose_collection = __commonJS((exports) => {
  ...
  var composeCollection = function(CN, ctx, token, tagToken, onError) {
    ...
    const node4 = identity.isNode(res) ? res : new Scalar.Scalar(res);
    node4.range = coll.range;
    node4.tag = tagName;
    if (tag?.format)
      node4.format = tag.format;
    return node4;
  };
  var identity = require_identity();
  var Scalar = require_Scalar();
...
var require_compose_node = __commonJS((exports) => {
  var composeNode = function(ctx, token, props, onError) {
    ...
    switch (token.type) {
      case "alias":
        node4 = composeAlias(ctx, token, onError);
        if (anchor || tag)
      ...
      case "double-quoted-scalar":
      case "block-scalar":
        node4 = composeScalar.composeScalar(ctx, token, tag, onError);
        if (anchor)
          node4.anchor = anchor.source.substring(1);
        break;
      case "block-map":
      case "block-seq":
      case "flow-collection":
        node4 = composeCollection.composeCollection(CN, ctx, token, tag, onError);
        if (anchor)
          node4.anchor = anchor.source.substring(1);
        break;
      default: {
        ...
        onError(token, "UNEXPECTED_TOKEN", message);
        node4 = composeEmptyNode(ctx, token.offset, undefined, null, props, onError);
        isSrcToken = false;
      }
    }
    if (anchor && node4.anchor === "")
      onError(anchor, "BAD_ALIAS", "Anchor cannot be an empty string");
    if (spaceBefore)
      node4.spaceBefore = true;
    if (comment) {
      if (token.type === "scalar" && token.source === "")
        node4.comment = comment;
      else
        node4.commentBefore = comment;
    }
    if (ctx.options.keepSourceTokens && isSrcToken)
      node4.srcToken = token;
    return node4;
  };
  var composeEmptyNode = function(ctx, offset, before, pos, { spaceBefore, comment, anchor, tag, end }, onError) {
    ...
    const node4 = composeScalar.composeScalar(ctx, token, tag, onError);
    if (anchor) {
      node4.anchor = anchor.source.substring(1);
      if (node4.anchor === "")
        onError(anchor, "BAD_ALIAS", "Anchor cannot be an empty string");
...
var require_cst_scalar = __commonJS((exports) => {
  ...
  var createScalarToken = function(value, context3) {
  ...
  var setScalarValue = function(token, value, context3 = {}) {
...
// node_modules/openapi3-ts/dist/server-DVBno7Ee.js
var require_server_DVBno7Ee = __commonJS((exports) => {
  var e = function(s, i) {
    if (s && r.isValidExtension(i))
      return s[i];
  };
  var o = function(s, i, t) {
...
// node_modules/openapi3-ts/dist/oas30-CAmzubQd.js
var require_oas30_CAmzubQd = __commonJS((exports) => {
  var p = function(e) {
...
var require_oas30 = __commonJS((exports) => {
  Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
  var e = require_oas30_CAmzubQd();
  var r = require_server_DVBno7Ee();
...
// node_modules/openapi3-ts/dist/oas31-Dtl9zIuV.js
var require_oas31_Dtl9zIuV = __commonJS((exports) => {
  var p = function(e) {
    const o = Object.create(null, { [Symbol.toStringTag]: { value: "Module" } });
    if (e) {
      for (const t in e)
...
var require_oas31 = __commonJS((exports) => {
  Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
  var e = require_oas31_Dtl9zIuV();
  var r = require_server_DVBno7Ee();
  exports.OpenApiBuilder = e.OpenApiBuilder;
  exports.getPath = e.getPath;
  exports.isReferenceObject = e.isReferenceObject;
...
var require_errors2 = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.UnknownZodTypeError = exports.MissingParameterDataError = exports.ConflictError = exports.ZodToOpenAPIError = undefined;
...
var require_enum_info = __commonJS((exports) => {
  var enumInfo = function(enumObject) {
...
var require_openapi_generator = __commonJS((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.OpenAPIGenerator = undefined;
  ...
  class OpenAPIGenerator {
      ...
      if ((0, zod_is_type_1.isZodType)(zodSchema, "ZodObject")) {
        ...
        const parameters = Object.entries(propTypes).map(([key, schema]) => {
          ...
          if ((innerParameterMetadata === null || innerParameterMetadata === undefined ? undefined : innerParameterMetadata.in) && innerParameterMetadata.in !== location) {
            throw new errors_1.ConflictError(`Conflicting location for parameter ${(_b = innerParameterMetadata.name) !== null && _b !== undefined ? _b : key}`, {
              key: "in",
    ...
    generateSchemaWithMetadata(zodSchema) {
      ...
      return (metadata === null || metadata === undefined ? undefined : metadata.metadata) ? this.applySchemaMetadata(result, metadata.metadata) : (0, lodash_1.omitBy)(result, lodash_1.isNil);
    }
    generateSimpleSchema(zodSchema) {
      ...
      const newMetadata = (0, lodash_1.omitBy)(this.buildSchemaMetadata((_a = metadata === null || metadata === undefined ? undefined : metadata.metadata) !== null && _a !== undefined ? _a : {}), (value, key) => value === undefined || (0, lodash_1.objectEquals)(value, schemaRef[key]));
      if (newMetadata.type) {
        return {
    ...
    getParameters(request3) {
      ...
      const { query, params, headers, cookies } = request3;
    ...
    generatePath(route) {
      ...
      const parameters = this.enhanceMissingParametersError(() => this.getParameters(request3), { route: `${method} ${path}` });
      const requestBody = this.getRequestBody(request3 === null || request3 === undefined ? undefined : request3.body);
      const routeDoc = {
    ...
    getResponse(_a) {
      ...
      const responseHeaders = (0, zod_is_type_1.isZodType)(headers, "ZodObject") ? this.getResponseHeaders(headers) : headers;
    ...
    toOpenAPISchema(zodSchema, isNullable, defaultValue) {
      ...
      if ((0, zod_is_type_1.isZodType)(zodSchema, "ZodArray")) {
        ...
        return Object.assign(Object.assign({}, this.mapNullableType("array", isNullable)), { items: this.generateSchemaWithRef(itemType), minItems: (_d = zodSchema._def.minLength) === null || _d === undefined ? undefined : _d.value, maxItems: (_e = zodSchema._def.maxLength) === null || _e === undefined ? undefined : _e.value, default: defaultValue });
      }
    ...
    toOpenAPIObjectSchema(zodSchema, isNullable, defaultValue) {
      var _a;
      const extendedFrom = (_a = this.getInternalMetadata(zodSchema)) === null || _a === undefined ? undefined : _a.extendedFrom;
      ...
      const propsOfParent = (0, lodash_1.mapValues)(parent === null || parent === undefined ? undefined : parent._def.shape(), (_) => this.generateSchemaWithRef(_));
...
var require_specifics = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.OpenApiGeneratorV30Specifics = undefined;
...
var require_openapi_generator2 = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.OpenApiGeneratorV3 = undefined;
...
var require_specifics2 = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.OpenApiGeneratorV31Specifics = undefined;
...
var require_openapi_generator3 = __commonJS((exports) => {
  var isWebhookDefinition = function(definition) {
    return "type" in definition && definition.type === "webhook";
  };
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.OpenApiGeneratorV31 = undefined;
  var openapi_generator_1 = require_openapi_generator();
...
var require_dist2 = __commonJS((exports) => {
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.OpenApiGeneratorV31 = exports.OpenApiGeneratorV3 = exports.OpenAPIV31 = exports.OpenAPIV3 = exports.OpenAPIRegistry = exports.extendZodWithOpenApi = undefined;
...
var require_url = __commonJS((exports, module) => {
  ...
  var getPath2 = (request3) => {
    const url6 = request3.url;
    const queryIndex = url6.indexOf("?", 8);
    return url6.slice(url6.indexOf("/", 8), queryIndex === -1 ? undefined : queryIndex);
  };
  var getQueryStrings2 = (url6) => {
    const queryIndex = url6.indexOf("?", 8);
    return queryIndex === -1 ? "" : "?" + url6.slice(queryIndex + 1);
  };
  var getPathNoStrict2 = (request3) => {
    const result = getPath2(request3);
  ...
  var _getQueryParam2 = (url6, key, multiple) => {
    let encoded;
    if (!multiple && key && !/[%+]/.test(key)) {
      let keyIndex2 = url6.indexOf(`?${key}`, 8);
      if (keyIndex2 === -1) {
        keyIndex2 = url6.indexOf(`&${key}`, 8);
      }
      while (keyIndex2 !== -1) {
        const trailingKeyCode = url6.charCodeAt(keyIndex2 + key.length + 1);
        if (trailingKeyCode === 61) {
          const valueIndex = keyIndex2 + key.length + 2;
          const endIndex = url6.indexOf("&", valueIndex);
          return _decodeURI2(url6.slice(valueIndex, endIndex === -1 ? undefined : endIndex));
        } else if (trailingKeyCode == 38 || isNaN(trailingKeyCode)) {
          return "";
        }
        keyIndex2 = url6.indexOf(`&${key}`, keyIndex2 + 1);
      }
      encoded = /[%+]/.test(url6);
      if (!encoded) {
        return;
    ...
    const results = {};
    encoded ??= /[%+]/.test(url6);
    let keyIndex = url6.indexOf("?", 8);
    while (keyIndex !== -1) {
      const nextKeyIndex = url6.indexOf("&", keyIndex + 1);
      let valueIndex = url6.indexOf("=", keyIndex);
      if (valueIndex > nextKeyIndex && nextKeyIndex !== -1) {
        valueIndex = -1;
      }
      let name = url6.slice(keyIndex + 1, valueIndex === -1 ? nextKeyIndex === -1 ? undefined : nextKeyIndex : valueIndex);
      if (encoded) {
      ...
      if (valueIndex === -1) {
        ...
        value = url6.slice(valueIndex + 1, nextKeyIndex === -1 ? undefined : nextKeyIndex);
        if (encoded) {
  ...
  var getQueryParams2 = (url6, key) => {
    return _getQueryParam2(url6, key, true);
  };
...
var require_http_exception = __commonJS((exports, module) => {
  ...
  class HTTPException2 extends Error {
    res;
    status;
...
var require_validator = __commonJS((exports, module) => {
  ...
  var import_cookie = require_cookie2();
        ...
        case "json":
          ...
          try {
            ...
            for (const type of bodyTypes) {
              const body2 = c.req.bodyCache[type];
              if (body2) {
                arrayBuffer = await new Response(await body2).arrayBuffer();
                break;
              }
            }
...
// node_modules/@hono/zod-validator/dist/cjs/index.js
var require_cjs = __commonJS((exports) => {
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.zValidator = undefined;
  var validator_1 = require_validator2();
  var zValidator = (target, schema, hook) => (0, validator_1.validator)(target, async (value, c) => {
...
var zod_to_openapi = __toESM(require_dist2(), 1);
var zod_to_openapi2 = __toESM(require_dist2(), 1);
var zod_validator = __toESM(require_cjs(), 1);
...
var OpenAPIHono = class _OpenAPIHono extends Hono2 {
  ...
  constructor(init) {
    super(init);
    this.openAPIRegistry = new zod_to_openapi.OpenAPIRegistry;
  ...
  openapi = (route, handler, hook = this.defaultHook) => {
    ...
    if (route.request?.query) {
      const validator2 = zod_validator.zValidator("query", route.request.query, hook);
      validators.push(validator2);
    }
    if (route.request?.params) {
      const validator2 = zod_validator.zValidator("param", route.request.params, hook);
      validators.push(validator2);
    }
    if (route.request?.headers) {
      const validator2 = zod_validator.zValidator("header", route.request.headers, hook);
      validators.push(validator2);
    }
    if (route.request?.cookies) {
      const validator2 = zod_validator.zValidator("cookie", route.request.cookies, hook);
      validators.push(validator2);
    }
      ...
      for (const mediaType of Object.keys(bodyContent)) {
        if (mediaType.startsWith("application/json")) {
          ...
          if (schema instanceof ZodType) {
            const validator2 = zod_validator.zValidator("json", schema, hook);
            validators.push(validator2);
          }
        }
        if (mediaType.startsWith("multipart/form-data") || mediaType.startsWith("application/x-www-form-urlencoded")) {
          const schema = bodyContent[mediaType]["schema"];
          if (schema instanceof ZodType) {
            const validator2 = zod_validator.zValidator("form", schema, hook);
            validators.push(validator2);
          }
        }
      }
  ...
  getOpenAPIDocument = (config) => {
    const generator = new zod_to_openapi.OpenApiGeneratorV3(this.openAPIRegistry.definitions);
    const document = generator.generateDocument(config);
    return document;
  };
  getOpenAPI31Document = (config) => {
    const generator = new zod_to_openapi.OpenApiGeneratorV31(this.openAPIRegistry.definitions);
    const document = generator.generateDocument(config);
    return document;
  };
  doc = (path, configure) => {
...
zod_to_openapi2.extendZodWithOpenApi(z);
...
async function checkCnameRecord(domain, targetCname) {
  try {
    const cnames = await lookupCname(domain);
    return cnames.includes(targetCname);
  } catch (error) {
    console.error(`Error checking CNAME record for domain ${domain}:`, error);
    return false;
  }
}
var lookupCname = promisify(dns.resolveCname);

// node_modules/@t3-oss/env-core/dist/index.js
var createEnv = function(opts) {
...
var domainsApi = new OpenAPIHono;
...
var VerifySchema = z.object({
  verified: z.boolean().default(false).openapi({ description: "If the domain is verified" })
}).openapi({
  description: "Verify",
  required: ["domain"]
});
var verifyRoute = createRoute({
  method: "get",
  tags: ["domains"],
